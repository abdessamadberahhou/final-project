...
@section('section-2')
    <div class="container-xl container-lg shadow mt-5">
        <table class="table table-striped">
            <tr>
                {!! Form::open(['action' => '\App\Http\Controllers\printController@search', 'method'=>'GET']) !!}
                <th class="col-1">
                ...
                @foreach($facture as $fac)
                    <tr>
                        ...
                        <td class="text-center">
                                ...
                                <a href="/print/fact/{{$fac->id}}" class="print-btn btn border-secondary text-secondary"><i class="bi bi-printer"></i></a>
                        </td>
                    </tr>
                @endforeach
        </table>
