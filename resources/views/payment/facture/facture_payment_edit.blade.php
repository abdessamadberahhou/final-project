...
@section('section-1')
    @if($facture!=null )
        {!! Form::open(['action'=>['paymentFactureController@update',$facture->id],'method'=>'post']) !!}
        ...
        <div class="facture_payment container shadow mt-5 p-5">
            <div class="row justify-content-around text-center">
                ...
                <div class="col-lg-5">
                    ...
                    <select type="text" class="form-control mx-auto" id="type_facture" name="type_facture">
                        @foreach($allfac as $fact)
                            <option
                                @if("{{$facture->type_facture}}" == "{{$fact->valeur_type}}")
                                selected="selected"
                                @endif
                                value="{{$fact->valeur_type}}">{{$fact->valeur_type}}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="row justify-content-around text-center mt-lg-4">
                <div class="col-lg-5">
                    ...
                    <input type="text" name="reference_facture" id="reference_facture" class="form-control" value="{{$facture->reference_facture}}" >
                </div>
                <div class="col-lg-5">
            ...
            <div class="row justify-content-around text-center mt-lg-4">
                <div class="col-lg-5">
                    ...
                    <input type="text" name="montant_facture" id="montant_facture" class="form-control" value="{{$facture->montant}}" >
                </div>
                <div class="col-lg-5">
